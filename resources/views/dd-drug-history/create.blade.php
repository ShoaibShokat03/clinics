                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a href="{{ route('dd-drug-history.index') }}">@lang('All Options')</a>
                        </li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{-- <form id="departmentForm" class="form-material form-horizontal bg-custom" action="{{ route('dd-drug-history.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="title" name="title" value="{{ old('title') }}" class="form-control @error('name') is-invalid @enderror" placeholder="@lang('Title')"data-parsley-pattern="^[a-zA-Z0-9\s]+$"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <a href="{{ route('dd-drug-history.index') }}" class="btn btn-outline btn-warning btn-lg">{{ __('Cancel') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form id="departmentForm" class="form-material form-horizontal bg-custom"
                        action="{{ route('dd-drug-history.store') }}" method="POST" enctype="multipart/form-data"
