                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a href="{{ route('teeth-procedures.index') }}">{{ __('Teeth Procedures') }}</a>
                        </li>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="patient_id"
                                            ...
                                            id="patient_id" {{ isset($teethProcedure) ? 'disabled' : '' }}>
                                        ...
                                        @if (isset($teethProcedure))
                                            <input type="hidden" name="patient_id"
                                                value="{{ $teethProcedure->patient_id }}">
                                        @endif
                                        @error('patient_id')
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        @if (isset($teethProcedure))
                                            <input type="text" class="form-control"
                                                value="{{ $teethProcedure->PatientAppointment->appointment_number }}"
                                                readonly>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        @if (isset($teethProcedure))
                                            <input type="text" class="form-control"
                                                value="{{ $teethProcedure->doctor->name }}" readonly>
                                            <input type="hidden" name="doctor_id"
                                                value="{{ $teethProcedure->doctor_id }}">
                                        @else
                                            <select name="doctor_id"
                                                class="form-control select2 @error('doctor_id') is-invalid @enderror"
                                                required id="doctor_id">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="type-of-selection"
                                style="display: {{ isset($teethProcedure) ? 'block' : 'none' }};">
                            ...
                            <div class="area-bulk-selection" style="display: none; margin-top: 30px;">
                                <form id="teethForm" style="display: {{ isset($teethProcedure) ? 'block' : 'none' }};">
                                    ...
                                    @if (isset($teethProcedure))
                                        ...
                                        <input type="hidden" name="patient_id"
                                            value="{{ $teethProcedure->patient_id }}">
                                        <input type="hidden" name="teeth_procedures_id"
                                            value="{{ $teethProcedure->id }}">
                                    @endif
                                    <div class="row">
                                        <div class="col-md-12">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="toothIssueForm">
                            ...
                            @endif
                            <input type="hidden" id="teeth_procedures_id" name="teeth_procedures_id"
                                value="{{ old('teeth_procedures_id', isset($teethProcedure) ? $teethProcedure->id : '') }}">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                    <div class="form-group">
                            ...
                            <div class="card">
                                ...
                                <button type="button" class="btn btn-primary" id="openSliderButton">Show Image
                                    Slider</button>
                            </div>
                        </form>
                    </div>
            ...
            $(document).ready(function() {
                ...
                function handleSingleSelection(teethElement) {
                    ...
                    $.ajax({
                        ...
                        url: '{{ url('/patient-teeth-issues') }}/' + procedureId + '/' + patientId + '/' +
                            teeth_number,
                        type: 'GET',
                        success: function(response) {
            ...
            function populateTeethFiles(response) {
                ...
                if (response.files) {
                    response.files.forEach(file => {
                        // file_name now contains the full path from public/, so use it directly with base URL
                        var filePath = '{{ asset('') }}' + file.file_name;
