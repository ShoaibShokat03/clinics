                ...
                <div class="card-body">
                    <div id="filter" class="collapse @if (request()->has('isFilterActive')) show @endif">
                        <div class="card-body border">
                            <form action="{{ route('items.index') }}" method="get" role="form" autocomplete="off">
                            ...
                            @foreach ($items as $item)
                                <tr>
                                    ...
                                    {{-- <td>{{ $item->user->name }}</td> --}}
                                     <td><span style="text-wrap:nowrap;">{{ $item->category ? $item->category->title : '-' }}</span></td>
                                    <td>{{ $item->subcategory ? $item->subcategory->title : '-' }}</td>
                                    <td>{{ $item->title }}</td>
