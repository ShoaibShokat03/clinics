...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                {{-- <form id="departmentForm" class="form-material form-horizontal bg-custom" action="{{ route('dd-medical-history.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
      ...
      action="{{ route('dd-medical-history.store') }}" method="POST"
