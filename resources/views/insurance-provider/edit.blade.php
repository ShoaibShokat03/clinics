            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row col-12 m-0 p-0">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="rating">Co-Percentage %</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-file"></i></span>
                                    </div>
                                    <input type="number" id="co_percentage" name="co_percentage" value="{{ old('co_percentage',$insuranceProvider->co_percentage) }}"
                                        class="form-control" 
                                        placeholder="@lang('Co-Percentage')">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="rating">Discount Amount %</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-file"></i></span>
                                    </div>
                                    <input type="number" id="discount_percentage" name="discount_percentage" value="{{ old('discount_percentage',$insuranceProvider->discount_percentage) }}"
                                        class="form-control" 
