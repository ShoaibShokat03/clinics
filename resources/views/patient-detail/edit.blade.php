...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">@lang('Edit Patient')</h1>
                </div>
                <div class="col-sm-6 text-right">

                    <div class="btn-group">
                        <a href="{{ route('patient-details.create') }}" class="btn btn-outline-success btn-sm">
                            <i class="fas fa-plus"></i> @lang('Add Patient')
                        </a>
                        <a href="{{ route('patient-details.index') }}" class="btn btn-outline-primary btn-sm ml-1">
    ...
    <div class="content">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white p-3 border-bottom-0">
                            <h3 class="card-title font-weight-bold">Edit Patient ({{ $patientDetail->name }}) </h3>
                        </div>
                        <div class="card-body">
                            <form id="departmentForm" class="form-material form-horizontal"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="gender"
                                                    ...
                                                    <option value="male"
                                                        @if (old('gender', $patientDetail->gender) == 'male') selected @endif>
                                                        @lang('Male')
                                                    </option>
                                                    <option value="female"
                                                        @if (old('gender', $patientDetail->gender) == 'female') selected @endif>
                                                        @lang('Female')
                                                    </option>
                                                </select>
                                                @error('gender')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="date" name="date_of_birth" id="date_of_birth"
                                                    ...
                                                    value="{{ old('date_of_birth', isset($patientDetail->date_of_birth) ? \Carbon\Carbon::parse($patientDetail->date_of_birth)->format('Y-m-d') : '') }}"
                                                    max="{{ date('Y-m-d') }}">
                                                @error('date_of_birth')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select
                                                    ...
                                                    <option value=""
                                                        @if (is_null(old('insurance_provider_id', $patientDetail->patientDetails->insurance_provider_id ?? null))) selected @endif>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="address" id="address"
                                                    ...
                                                    rows="1" value="{{ old('address', $patientDetail->address) }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="status">@lang('Status') <b
                                                    class="ambitious-crimson">*</b></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                ...
                                                <select
                                                    ...
                                                    <option value="1"
                                                        @if (old('status', $patientDetail->status) == '1') selected @endif>
                                                        @lang('Active')
                                                    </option>
                                                    <option value="0"
                                                        @if (old('status', $patientDetail->status) == '0') selected @endif>
                                                        @lang('Inactive')
                                                    </option>
                                                </select>
                                                @error('status')
            ...
            <div
                class="card shadow-sm border-0 {{ isset($patientDetail->patientDetails) && $patientDetail->patientDetails->insurance_provider_id !== null ? 'd-block' : 'd-none' }}">
                <div class="card-header bg-white p-3 border-bottom-0">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-check {{ $insuranceFiles > 0 ? 'd-block' : 'd-none' }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p>{{ __('Max Size: 2048kb, Allowed Format: png, jpg, jpeg, pdf, xml, txt, doc, docx, mp4') }}
                            </p>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-bordered">
