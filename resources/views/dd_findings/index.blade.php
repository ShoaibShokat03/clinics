    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h3>
                    <a href="{{ route('dd-findings.create') }}" class="btn btn-outline btn-info">+ @lang('Add New Finding')</a>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">@lang('Findings List')</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="card-title">@lang('Findings List')</h3>
            ...
            <div class="card-body">
                ...
                <table class="table table-striped" id="laravel_datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><span style="text-wrap:nowrap;">{{ $finding->name }}</span></td>
                            <td>
                                @if ($finding->status == '1')
                            ...
                            <td class="responsive-width">
                                @can('dropdown-update')
                                <a href="{{ route('dd-findings.edit', $finding) }}"
                                ...
                                @endcan
                                @can('dropdown-delete')
                                <a href="#" data-href="{{ route('dd-findings.destroy', $finding) }}"
                ...
                {{ $ddFindings->withQueryString()->links() }}
            </div>
        </div>
    </div>
</div>
