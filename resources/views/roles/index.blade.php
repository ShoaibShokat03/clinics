                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                value="{{ request()->name }}" placeholder="@lang('Role Name')">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="role_for">
                                                ...
                                                <option value="0"
                                                    {{ old('role_for', request()->role_for) === '0' ? 'selected' : '' }}>
                                                    @lang('User')</option>
                                                <option value="1"
                                                    {{ old('role_for', request()->role_for) === '1' ? 'selected' : '' }}>
                                                    @lang('Staff')</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            @foreach ($roles as $role)
                                <tr>
                                    ...
                                    <td class="responsive-width">
                                        ...
                                        @endcan
                                        @can('role-delete')
                                            <a href="#" data-href="{{ route('roles.destroy', $role) }}"
                                                class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg"
