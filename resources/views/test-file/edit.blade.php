...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="doctor_id"
                                            ...
                                            id="doctor_id" {{ isset($testFile) ? 'disabled' : '' }}>
                ...
                <div class="type-of-selection">
                    ...
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" value="bulk" id="option-bulk-selection" class="form-check-input"
                                name="optradio">Bulk Selection
                        </label>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <form id="toothIssueForm">
                        ...
                        <input type="hidden" id="teeth_procedures_id" name="teeth_procedures_id"
                            value="{{ old('teeth_procedures_id', isset($testFile) ? $testFile->id : '') }}">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                <div class="form-group">
                                    <label for="tooth_number">@lang('Tooth') <b class="ambitious-crimson">*</b></label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
    ...
    <script>
        ...
        function fetchImages(procedureId, teethNumber) {
            $.ajax({
                url: '{{ route('get-teeth-files') }}', // Adjust the route as needed
                type: 'GET',
                data: {
                    procedure_id: procedureId,
                    tooth_number: teethNumber
