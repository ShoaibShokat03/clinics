...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="departmentForm" class="form-material form-horizontal bg-custom" action="{{ route('patient-case-studies.update', $patientCaseStudy) }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
                    @csrf
                    @method('PUT')
                    <div class="row col-12 p-0 m-0">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="user_id" id="user_id" class="form-control custom-width-100 select2 @error('user_id') is-invalid @enderror"
                                        required
                                    ...
                                    @if (!is_null(optional($patient->user)->name))
                                        <option value="{{ $patient->user_id }}" @if($patient->user_id == old('user_id', $patientCaseStudy->user_id )) selected @endif>
