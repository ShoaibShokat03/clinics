...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="patientForm" class="form-material form-horizontal bg-custom" action="{{ route('patient-case-studies.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
                    @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_id" id="user_id"
                                    ...
                                    @if (!is_null(optional($patient->user)->name))
                                        <option value="{{ $patient->user_id }}" @if($patient->user_id == old('user_id', $selectedPatient ?? '')) selected @endif>
