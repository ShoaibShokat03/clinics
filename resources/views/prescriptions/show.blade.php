...
<section class="content-header no-print">
    <div class="container-fluid">
        <div class="row align-items-center mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">@lang('Prescription View')</h1>
            </div>
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div id="print-area" class="card-body">
                        ...
                        @endphp
                        <div class="prescription" id="prescription-container" style="padding-top: {{ $marginTop }}mm !important; padding-left: {{ $marginLeft }}mm !important;">
                            <div id="companyInfoBox" class="clinic-header {{ $showHeader ? '' : 'd-none' }}">
                                <div class="clinic-logo-box">
                                    ...
                                    <img src="{{ asset('public/'.$applicationSettings[0]['logo']) }}" alt="Logo" class="clinic-logo">
                                    @else
                            ...
                            <table class="info-table">
                                <tr>
                                    <td><strong>@lang('Patient'):</strong> {{ $prescription->user->name }}</td>
                                    <td><strong>@lang('MRN#'):</strong> {{ $prescription->user->patientDetails->mrn_number ?? '' }}</td>
                                    <td><strong>@lang('Date'):</strong> {{ date('d M Y', strtotime($prescription->prescription_date)) }}</td>
                                </tr>
                                <tr>
                                    <td><strong>@lang('Doctor'):</strong> {{ $prescription->doctor->name ?? 'N/A' }}</td>
                                    <td><strong>@lang('Prescription#'):</strong> {{ str_pad($prescription->id, 4, '0', STR_PAD_LEFT) }}</td>
                                    <td><strong>@lang('Gender'):</strong> {{ $prescription->user->gender ?? '' }}</td>
                                </tr>
                            </table>

                            <h5 class="font-weight-bold mt-4 mb-3">@lang('Medicines')</h5>
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="text-align: left;">{{ $item->ddmedicine->name ?? '-' }}</td>
                                        <td>{{ $item->ddmedicinetype->name ?? '-' }}</td>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <h6 class="font-weight-bold">@lang('Note'):</h6>
