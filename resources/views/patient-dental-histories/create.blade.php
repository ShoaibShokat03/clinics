...
<section class="content-header">
    <div class="container-fluid">
        <div class="row align-items-center mb-2">
            <div class="col-sm-6">
                <h3 class="m-0 text-dark">@lang('Add Dental History')</h3>
            </div>
            <div class="col-sm-6 text-right">
                <a href="{{ route('patient-dental-histories.index') }}" class="btn btn-outline-info btn-sm">
...
<div class="content">
    <div class="container-fluid">
        <form id="dentalhistoryForm" action="{{ route('patient-dental-histories.store') }}" method="POST" data-parsley-validate>
            @csrf
