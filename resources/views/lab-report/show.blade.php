        ...
        <div class="card">
            ...
            <div class="card-body">
                <div id="print-area" class="row">
                    ...
                    <div class="row ">
                        <div class="col-12">
                            <h4 class="pb-3"><img src="{{ asset('public/'.$ApplicationSetting->logo) }}" alt="{{ $ApplicationSetting->item_name }}"
                    ...
                    <div class="row col-12 p-0 m-0">
                        ...
                        <div class="col-8 text-right">
                            <h6 class="size">@lang('MRN no'):
                                {{ $labReport->user->patientDetails->mrn_number ?? ' ' }}
                            </h6>
                        </div>
                    ...
                    <div class="row col-12 p-0 m-0">
                        ...
                        <div class="col-8 text-right">
                            <h6 class="size">
                                @lang('Report Date'):
                                {{ date($companySettings->date_format ?? 'Y-m-d', strtotime($labReport->date)) }} <br>
                            </h6>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            $picPath = $pic;
                            if (!str_starts_with($picPath, 'public/') &&
                            !str_starts_with($picPath, 'storage/') &&
                            !str_starts_with($picPath, 'http://') &&
                            !str_starts_with($picPath, 'https://')) {
                            $picPath = 'public/' . $picPath;
                            }
                            @endphp
                            <a data-magnify="gallery" data-caption="Report"
                                href="{{ asset($picPath) }}">
                                <img id="custom-mw-heo" class="rounded" src="{{ asset($picPath) }}" alt="">
                            </a>
                            @endif
                            @endforeach
                            @endif
