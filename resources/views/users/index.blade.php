                        ...
                        @foreach ($users as $user)
                            ...
                            <tr>
                                ...
                                <td class="responsive-width">
                                    @can('user-update')
                                        <a href="{{ route('users.edit', $user->id) }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                    @endcan
                                    @can('user-delete')
                                    <a href="#" data-href="{{ route('users.destroy', $user->id) }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                    @endcan
                                </td>
                            </tr>
                        @endforeach
