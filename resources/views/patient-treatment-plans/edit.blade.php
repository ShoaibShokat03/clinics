    ...
    <section class="content-header">
        ...
        <div class="container-fluid">
            <div class="row align-items-center mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">@lang('Edit Treatment Plan')</h1>
                </div>
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white p-3 border-bottom-0">
                            <h3 class="card-title font-weight-bold">@lang('Treatment Plan') -
                                {{ $patientTreatmentPlan->treatment_plan_number }}</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('patient-treatment-plans.update', $patientTreatmentPlan) }}"
                                method="POST">
                                @method('PUT')
                                @csrf
                                                    ...
                                                    @foreach ($doctors as $doctor)
                                                        @if ($doctor->user && !is_null($doctor->user->name))
                                                            <option value="{{ $doctor->user_id }}"
                                                                {{ $patientTreatmentPlan->doctor_id == $doctor->user_id ? 'selected' : '' }}>
                                                                {{ $doctor->user->name ?? '' }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                                ...
                                <div class="row mt-4 align-items-center">
                                    <div class="col-md-5">
                                        <button type="submit"
                                            class="btn btn-primary btn-lg px-5">@lang('Update')</button>
                                    ...
                                    <div class="col-md-7 text-md-right">
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('patient-treatment-plans.show', ['patient_treatment_plan' => $patientTreatmentPlan->id, 'print' => 'all']) }}"
                                                ...
                                                style="{{ $hasPlanProcedures ? '' : 'display:none;' }}">
                                                <i class="fas fa-print"></i> @lang('Print All Plan')
                                            </a>
                                            ...
                                            <a href="{{ route('patient-treatment-plans.show', ['patient_treatment_plan' => $patientTreatmentPlan->id, 'print' => 'ready']) }}"
                                                ...
                                                style="{{ $hasReadyToStartProcedures ? '' : 'display:none;' }}">
                                                <i class="fas fa-print"></i> @lang('Print Ready to Procedure')
                                            </a>

                                            <a href="#" id="generate-invoice"
                                                class="btn btn-outline-success btn-sm ml-2"
                                                style="{{ $showGenerateInvoiceButton ? '' : 'display:none;' }}">
                                                <i class="fas fa-file-invoice"></i> @lang('Generate Invoice')
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card shadow-none overflow-hidden mb-3" style="border: 1px solid #0066CC;"
                    ...
                    <div class="card-header bg-light py-2 d-flex align-items-center"
                        ...
                        <h3 class="card-title mb-0 font-weight-bold text-primary" style="font-size: 1rem;">
                            @lang('Tooth') {{ $tooth->tooth_number }}</h3>
                    </div>
                        ...
                        <div class="tooth-issues bg-custom p-2 mb-2">
                            @foreach ($tooth->toothIssues as $issue)
                                <div class="alert alert-light" style="display: inline-block; margin-right: 30px;">
                                    <h5 style="font-size:11px; font-weight:bold;">{{ $issue->tooth_issue }}
                                        {{ $issue->diagnosis ? ', ' . $issue->diagnosis->name : '' }} </h5>
                                            ...
                                            <tr class="treatment-plan-inner-row" data-id="{{ $planProcedure->id }}">
                                                    ...
                                                    <select required name="procedure_category[]"
                                                        ...
                                                        @foreach ($procedureCategories as $procedureCategory)
                                                            <option value="{{ $procedureCategory->id }}"
                                                                {{ $planProcedure->procedure->dd_procedure_id == $procedureCategory->id ? 'selected' : '' }}>
                                                ...
                                                <td class="border col-xl-3 p-1">
                                                    <select required name="procedure[]"
                                                        ...
                                                        @foreach ($procedures as $procedure)
                                                            <option value="{{ $procedure->id }}"
                                                                {{ $planProcedure->dd_procedure_id == $procedure->id ? 'selected' : '' }}>
                                                                {{ $procedure->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <td class="border p-1 col-xl-1 text-center"
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <span
                                                            class="cost font-weight-bold mr-2">{{ $planProcedure->procedure->price }}</span>
                                                ...
                                                <td class="border p-1 col-xl-5">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="d-flex align-items-center action-buttons-container">
                                                            {{-- Always show notes buttons for saved rows --}}
                                                            <button type="button"
                                                            ...
                                                            <div class="modal fade model_add_notes"
                                                                id="declineModal_{{ $tooth->tooth_number }}"
                                                                tabindex="-1" role="dialog"
                                                                aria-labelledby="declineModalLabel_{{ $tooth->tooth_number }}"
                                                                aria-hidden="true" style="display: none;">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="declineModalLabel_{{ $tooth->tooth_number }}">
                                                                                Add notes for tooth
                                                                                {{ $tooth->tooth_number }}</h5>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form method="POST"
                                                                                id="notesForm_{{ $tooth->tooth_number }}"
                                                                                class="p-4 rounded bg-light submit_notes_form">
                                                                                @csrf
                                                                                <div class="form-group mb-3">
                                                                                    <label
                                                                                        for="treatment_notes_{{ $tooth->tooth_number }}"
                                                                                        class="form-label fw-bold">Write
                                                                                        notes for tooth
                                                                                        {{ $tooth->tooth_number }} <i
                                                            ...
                                                            <div class="modal fade show_treatment_notes"
                                                                id="showModal{{ $tooth->tooth_number }}" tabindex="-1"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#generate-invoice').click(function(e) {
                ...
                var url = "{{ route('auto-invoices.create') }}";
