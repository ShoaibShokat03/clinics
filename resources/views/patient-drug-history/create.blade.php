...
<section class="content-header">
    <div class="container-fluid">
        <div class="row align-items-center mb-2">
            <div class="col-sm-6">
                <h3 class="m-0 text-dark">@lang('Add Drug History')</h3>
            </div>
            <div class="col-sm-6 text-right">
                <a href="{{ route('patient-drug-histories.index') }}" class="btn btn-outline-info btn-sm">
...
<div class="content">
    <div class="container-fluid">
        <form id="drughistoryForm" action="{{ route('patient-drug-histories.store') }}" method="POST" data-parsley-validate>
            @csrf
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="history-item-card p-3 border rounded h-100">
                                ...
                                <div class="form-group mb-0 history-comment-group" style="display:none;">
                                    ...
                                    <input type="hidden" value="{{ $item->id }}" name="drug_histories[{{ $item->id }}][title_id]">
                                </div>
                            </div>
                        </div>
                        @endforeach
