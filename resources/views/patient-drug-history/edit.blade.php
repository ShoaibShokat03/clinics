    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0 text-dark">@lang('Edit Drug History')</h3>
                </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white p-3 border-bottom">
                    <h3 class="card-title font-weight-bold">
                        ...
                        @lang('Drug History for') {{ $patient->name }}
                    </h3>
                </div>
                    ...
                    <form id="drughistoryForm" action="{{ route('patient-drug-histories.update', $patient->id) }}"
                        ...
                        <div class="row">
                            @foreach ($ddDrugHistories as $item)
                                @php
                                    $historyRecord = $patientDrugHistories
                                        ->where('dd_drug_history_id', $item->id)
                                        ->first();
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body p-4">
                    <div class="upload-area mb-4">
                        ...
                        <input id="drug_history" name="drug_history[]" type="file" multiple
