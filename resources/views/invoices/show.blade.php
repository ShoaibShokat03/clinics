    ...
    <section class="content-header no-print">
        <div class="container-fluid">
            <div class="row align-items-center mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">@lang('Invoice View')</h1>
                </div>
                        ...
                        <div id="print-area" class="card-body">
                            ...
                            <div class="invoice" id="invoice-container"
                                ...
                                <div id="clinicHeader" class="clinic-header {{ $showHeader ? '' : 'd-none' }}">
                                    <h4>{{ $company->item_name ?? 'Company Name' }}</h4>
                                ...
                                <table class="patient-info-table">
                                    <tr>
                                        <td><strong>@lang('Patient'):</strong> {{ $invoice->user->name }}</td>
                                    ...
                                    <tr>
                                        <td><strong>@lang('Doctor'):</strong> {{ $invoice->doctor->name ?? 'N/A' }}</td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="3" style="text-align: right;">
                                                <strong>@lang('Total')</strong></td>
                                            <td>{{ number_format($invoice->total, 2) }}</td>
                                        </tr>
                                        @if ($invoice->total_discount > 0)
                                            <tr>
                                                <td colspan="3" style="text-align: right;">
                                                    <strong>@lang('Discount')</strong></td>
                                                <td>{{ number_format($invoice->total_discount, 2) }}</td>
                                            </tr>
                                        @endif
                                        <tr>
                                            <td colspan="3" style="text-align: right;">
                                                <strong>@lang('Grand Total')</strong></td>
                                            <td>{{ number_format($invoice->grand_total, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="text-align: right; color: green;">
                                                <strong>@lang('Paid')</strong></td>
                                            <td style="color: green;">{{ number_format($invoice->paid, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="3" style="text-align: right; color: red;">
                                                <strong>@lang('Due')</strong></td>
                                            <td style="color: red;">{{ number_format($invoice->due, 2) }}</td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
