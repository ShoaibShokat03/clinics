                            ...
                            <form action="" method="get" role="form" autocomplete="off">
                                ...
                                <div class="col-sm-3 align-content-center">
                                        ...
                                        @if(request()->isFilterActive)
                                            <a href="{{ route('account-headers.index') }}" class="btn btn-secondary mt-4">@lang('Clear')</a>
                                        @endif
                                    </div>
                                </div>
                            </form>
                        ...
                        <tbody>
                            @foreach ($accountHeaders as $accountHeader)
                                <tr>
                                    ...
                                    <td><span style="text-wrap:nowrap;">{{ $accountHeader->name }}</span></td>
                                    ...
                                    <td class="responsive-width">
                                        <a href="{{ route('account-headers.show', $accountHeader) }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('View')"><i class="fa fa-eye ambitious-padding-btn"></i></a>
                                        @can('account-header-update')
                                            <a href="{{ route('account-headers.edit', $accountHeader) }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                        @endcan
                                        @can('account-header-delete')
                                            <a href="#" data-href="{{ route('account-headers.destroy', $accountHeader) }}" class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')"><i class="fa fa-trash ambitious-padding-btn"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
