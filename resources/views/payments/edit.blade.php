                        ...
                        <div class="row col-12 m-0 p-0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group input-group mb-3">
                                    ...
                                    <input type="text" id="paid_by" name="paid_by" value="{{ old('paid_by', $payment->paid_by) }}"  class="form-control">
                                    @error('paid_by')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-group input-group mb-3">
                                    ...
                                    <input type="text" id="material_name" name="material_name" value="{{ old('material_name', $payment->material_name) }}"  class="form-control">
                                    @error('material_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-group input-group mb-3">
                                    ...
                                    <input type="text" id="payment_method" name="payment_method" value="{{ old('payment_method', $payment->payment_method) }}"  class="form-control">
