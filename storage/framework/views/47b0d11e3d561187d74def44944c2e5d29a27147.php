    ...
    <div class="login-box">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white text-center border-bottom-0">
                ...
                <p class="login-msg"><?php echo app('translator')->get('Sign in to start your session'); ?></p>
            </div>
...
<?php /**PATH E:\dental\dental-main\resources\views/page/login.blade.php ENDPATH**/ ?>