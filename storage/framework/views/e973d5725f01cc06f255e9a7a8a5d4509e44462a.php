                    ...
                    <div class="card shadow-sm border-0">
                        <div
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('doctor-detail-update')): ?>
                                <a href="<?php echo e(route('doctor-details.edit', $doctorDetail)); ?>"
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-md-3 text-center d-flex justify-content-center align-items-center">
                                    <img src="<?php echo e($doctorDetail->user->photo_url); ?>"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-2">
                                        ...
                                        <p class="font-weight-normal mb-0"><?php echo e(ucfirst($doctorDetail->user->gender ?? '-')); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-2">
                                        ...
                                        <p class="font-weight-normal mb-0">
                                            <?php echo e($doctorDetail->user->ddbloodgroup->name ?? ' '); ?></p>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group mb-2">
                                        ...
                                        <p class="font-weight-normal mb-0">
                                            <?php echo e($doctorDetail->user->date_of_birth ? \Carbon\Carbon::parse($doctorDetail->user->date_of_birth)->format('d-M-Y') : '-'); ?>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $patientAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($appointment->start_time); ?> - <?php echo e($appointment->end_time); ?>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo e(route('prescriptions.show', $prescription->id)); ?>"
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\dental\dental-main - 04-Feb-2026\resources\views/doctor-detail/show.blade.php ENDPATH**/ ?>