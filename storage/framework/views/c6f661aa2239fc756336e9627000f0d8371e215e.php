    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0 text-dark"><?php echo app('translator')->get('Edit Medical History'); ?></h3>
                </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white p-3 border-bottom">
                    <h3 class="card-title font-weight-bold">
                        ...
                        <?php echo app('translator')->get('Medical History for'); ?> <?php echo e($patient->name); ?>

                    </h3>
                </div>
                <div class="card-body p-4">
                    <form id="medicalhistoryForm" action="<?php echo e(route('patient-medical-histories.update', $patient->id)); ?>"
                        method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <input type="hidden" name="patient" value="<?php echo e($patient->id); ?>">
                        <input type="hidden" name="doctor" value="<?php echo e($patientMedicalHistories[0]->doctor_id); ?>">

                        <div class="row">
                            <?php $__currentLoopData = $ddMedicalHistories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $historyRecord = $patientMedicalHistories
                                        ->where('dd_medical_history_id', $item->id)
                                        ->first();
                                    ...
                                    <div
                                        ...
                                        <div class="form-group mb-0 history-comment-group"
                                            ...
                                            <input type="hidden" value="<?php echo e($item->id); ?>"
                                                name="medical_histories[<?php echo e($item->id); ?>][title_id]">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white p-3 border-bottom">
                    <h3 class="card-title font-weight-bold">
                        ...
                        <?php echo app('translator')->get('Medical Documents'); ?>
                    </h3>
                </div>
                <div class="card-body p-4">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\dental\dental-main\resources\views/patient-medical-histories/edit.blade.php ENDPATH**/ ?>