                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form method="POST"
                                                                                ...
                                                                                <div class="form-group mb-3">
                                                                                    ...
                                                                                    <textarea name="treatment_notes" id="treatment_notes_<?php echo e($tooth->tooth_number); ?>" class="form-control"
                                                                                        rows="4" placeholder="Add notes here..."></textarea>
                                                                                </div>
                                                                                <input type="hidden"
                                                                    ...
                                                                    <form method="POST" id="notesForm_null"
                                                                        ...
                                                                        <div class="form-group mb-3">
                                                                            <label for="treatment_notes_null"
                                                                                ...
                                                                                <i
                                                                                    class="bi bi-pencil-square ms-2"></i></label>
                                                                            <textarea name="treatment_notes" id="treatment_notes_null" class="form-control" rows="4"
            ...
            $(document).on("click", ".m-save", function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (dataId == response.planProcedure.id || dataId == 'new-row' || !
                            dataId) {
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\dental\dental-main\resources\views/patient-treatment-plans/edit.blade.php ENDPATH**/ ?>