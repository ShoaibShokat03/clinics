            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('patient-social-histories-create')): ?>
                        <h3>
                            <a href="<?php echo e(route('patient-social-histories.create')); ?>" class="btn btn-outline btn-info">+
                                <?php echo app('translator')->get('Add Patient Social History'); ?>
                            </a>
                        </h3>
                    <?php endif; ?>
                </div>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><?php echo app('translator')->get('Patient Social History List'); ?></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title"><?php echo app('translator')->get('Patient Social History List'); ?></h3>
                    <div class="card-tools">
                        <a class="btn btn-primary float-right" target="_blank"
                            href="<?php echo e(route('patient-social-histories.index')); ?>?export=1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="name" class="form-control select2" id="patient_id">
                                                <option value="">--<?php echo app('translator')->get('Select'); ?>--</option>
                                                <?php $__currentLoopData = $patients->sortBy(fn($patient) => strtolower($patient->user->name ?? '')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($patient->name); ?>" <?php echo e(old('name', request()->name == $patient->name ? 'selected' : '')); ?>>
                    ...
                    <table class="table table-striped" id="laravel_datatable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $patients->sortBy(fn($patient) => strtolower($patient->name ?? '')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><span><?php echo e($patient->patientDetails->mrn_number ?? ' '); ?></span></td>

                                    <td><?php echo e($patient->name); ?></td>
                                    <td>
                                        <?php if($patient->patientSocialHistories->isNotEmpty()): ?>
                                            <?php echo e($patient->patientSocialHistories->first()->doctor->name ?? 'N/A'); ?>
                                    ...
                                    <td class="responsive-width">
                                        <?php if($patient->patientSocialHistories->isNotEmpty()): ?>
                                            <a href="<?php echo e(route('patient-social-histories.show', $patient->patientSocialHistories->first())); ?>"
                                        ...
                                        <?php if($patient->patientSocialHistories->isNotEmpty()): ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('patient-social-histories-update')): ?>
                                                <a href="<?php echo e(route('patient-social-histories.edit', $patient->patientSocialHistories->first())); ?>"
                                                    class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg"
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\dental\dental-main\resources\views/patient-social-histories/index.blade.php ENDPATH**/ ?>