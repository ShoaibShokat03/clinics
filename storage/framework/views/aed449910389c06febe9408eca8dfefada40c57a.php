    ...
    <script>
        $(document).ready(function() {
            ...
            $('#applyAllTeethModal').on('show.bs.modal', function() {
                ...
                $firstRow.find('.m-remove').prop('disabled', true);
            });
            ...
            $(document).off('click', '#applyAllTeethModal .m-add').on('click', '#applyAllTeethModal .m-add',
                function() {
                    ...
                    // Remove select2 container and reset select attributes
                    $newRow.find('.select2-container').remove();
                    $newRow.find('select')
                        .removeClass('select2-hidden-accessible')
                        .removeAttr('data-select2-id')
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\dental\dental-main - 04-Feb-2026\resources\views/exam-investigation/edit.blade.php ENDPATH**/ ?>