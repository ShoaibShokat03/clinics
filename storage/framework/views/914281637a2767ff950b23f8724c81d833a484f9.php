...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row dashboard-cards-section">
        ...
        <div class="col-md-4 col-sm-6 col-12 col-lg-3 mt-3">
            <div class="dashboard-stat-card">
                <div class="stat-card-header">
                    <div class="info-box-label"><?php echo app('translator')->get('Exam & Diagnosis.'); ?></div>
                    <div class="info-box-today"><?php echo app('translator')->get('Today'); ?>:
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\dental\dental-main - 05-Feb-2026\resources\views/dashboardview.blade.php ENDPATH**/ ?>