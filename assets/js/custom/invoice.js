$(document).ready(function () {
    ...
    $(document).on('click', '.m-remove', function () {
        ...
        if (confirmed) {
            ...
            calculateSubtotalsAndTotals(); // Call your function to update totals
        }
    });
    ...
    function calculateDiscount() {
        ...
        discount_percentage = (!discount_percentage || isNaN(discount_percentage)) ? 0 : parseFloat(discount_percentage);
        ...
        vat_percentage = (!vat_percentage || isNaN(vat_percentage)) ? 0 : parseFloat(vat_percentage);
    ...
    function calculateVat() {
        ...
        let vat = $('.vat').val();
        vat = (!vat || isNaN(vat)) ? 0 : parseFloat(vat);
    ...
    function calculatePaid() {
        let paid = $('.paid').val();
        paid = (!paid || isNaN(paid)) ? 0 : parseFloat(paid);
