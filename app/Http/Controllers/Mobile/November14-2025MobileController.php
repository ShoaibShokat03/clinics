...
class MobileController extends Controller
{
    ...
    public function adminPatientsList(Request $request)
    {
        try {
            ...
            $query = PatientDetail::with('user:id,name,email,phone,gender,date_of_birth,address')
                ->whereHas('user');
            ...
            $patientsData = $patients->map(function ($patient) {
                ...
                return [
                    ...
                    'joining_date' => $patient->user->created_at ? $patient->user->created_at->toDateTimeString() : null,
                    'total_appointments' => $totalAppointments,
                    'total_invoices' => $totalInvoices
                ];
            });
