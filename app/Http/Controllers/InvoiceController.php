...
class InvoiceController extends Controller
{
    ...
    public function newTemplate(Request $request, $id)
    {
        try {
            ...
            $pageSetting = PageSetting::where('page_name', 'invoice_show')->first();
            $pageSettings = $pageSetting ? $pageSetting->settings : [];

            return view('invoices.invoiceTemplate', [
                'patient' => $patient,
    ...
    public function create(Request $request)
    {
        ...
        if ($request->treatment_plan_id) {
            ...
            return view('invoices.create', compact('patients', 'patientTreatmentPlan', 'insurances', 'accountHeader', 'patientTreatmentPlanProcedures', 'teeth', 'doctors', 'percentage', 'medicineTypes'));
        }
        ...
        $selectedPatientId = $request->userid;
        return view('invoices.create', compact('accountHeader', 'insurances', 'patients', 'doctors', 'procedureCategories', 'procedures', 'medicineTypes', 'selectedPatientId'));
    }
    ...
    public function show(Invoice $invoice)
    {
        ...
        return view('invoices.show', compact('company', 'invoice', 'pageSettings'));
    }
