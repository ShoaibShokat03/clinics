...
class TaskController extends Controller
{
    ...
    {
        $this->middleware('permission:task-read|task-create|task-update|task-delete', ['only' => ['index','show']]);
        $this->middleware('permission:task-create', ['only' => ['create','store']]);
        $this->middleware('permission:task-update', ['only' => ['edit','update','updateStatus']]);
        $this->middleware('permission:task-delete', ['only' => ['destroy']]);
        $this->middleware('permission:task-read', ['only' => ['assignTasks']]);
    }
    ...
    public function filter(Request $request)
    {
        ...
        // Add filtering for assign task page
        if ($request->has('view_type') && $request->view_type === 'assigned') {
            $query->where('assign_by', auth()->id());
        }
    ...
    public function store(Request $request)
    {
        ...
        $eventData = [
            ...
            'assign_to' => $task->assign_to, // Set the eventtype
        ];
    ...
    public function destroy(Task $task)
    {
        ...
        return redirect()->route('tasks.assigned')->with('success', 'Task deleted successfully.');
    }
    ...
    // Add new method for assign task page
    public function assignTasks(Request $request)
    {
        ...
        $request->merge(['view_type' => 'assigned']);
