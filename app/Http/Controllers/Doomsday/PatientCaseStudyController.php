...
class PatientCaseStudyController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(patientDetail $patientCaseStudy)
    {
        // $tablename="patient_case_studies";
        // $logid=$patientCaseStudy->id;
        // $logs = UserLogs::where('table_name', $tablename)
        // ->where('student_id', $logid)
        // ->get();
