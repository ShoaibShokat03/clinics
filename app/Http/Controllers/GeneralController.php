...
class GeneralController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        if ($request->company_logo) {
            ...
            $uploadPath = getUploadPublicPath('companies');
            $logo->move($uploadPath, $logoNewName);
            $logoUrl = getFullUploadPath('companies/' . $logoNewName);
            Setting::updateOrCreate(['company_id' => $id, 'key' => 'general.company_logo'], ['value' => $logoUrl]);
        }
