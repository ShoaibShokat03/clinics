...
class DashboardController extends Controller
{
    ...
    private function dashboardCounts()
    {
        ...
        return [
            ...
            'today_exam_investigation' => ExamInvestigation::whereDate('created_at', Carbon::today())->count(),
            'treatment_plans' => PatientTreatmentPlan::count(),
            'today_treatment_plans' => PatientTreatmentPlan::whereDate('created_at', Carbon::today())->count(),
            ...
            'today_patients' => User::role('Patient')->whereDate('created_at', Carbon::today())->count(),
            ...
            'today_appointments' => PatientAppointment::whereDate('appointment_date', Carbon::today())->count(),
            ...
            'today_prescriptions' => Prescription::whereDate('created_at', Carbon::today())->count(),
            'invoices' => Invoice::count(),
            'unpaid_invoices' => Invoice::where('due', '>', 0)->count(),
            'payments' => Payment::count(),
            'today_payments' => Payment::whereDate('payment_date', Carbon::today())->count(),
            'totaldiscount' => Invoice::sum('total_discount'),
            'total' => Invoice::sum('total'),
            'labReports' => DentalLabOrder::count(),
            'today_labReports' => DentalLabOrder::whereDate('created_at', Carbon::today())->count(),
